...
def main():
    ...
    local_bolt = <bolt> ## enter bolt port
    local_pw = <password> ## enter password
    local_user = <user> ## enter user
    ...
    query_offshore_insertion_denormalized_3 = "MATCH (e:Entity) WHERE e.name = 'new' DELETE e"
    ...
    #####################################################################################
    #####################################################################################
    query = query_offshore_point_normalized
    ...
    for i in range(0, runs):
        ...
        # comment in for deletion of new nodes and adjust depending on normalisation for insertion experiments
        #
